...
def dib_diagrama(ventana):
    ...
    minum1 = miFuente.render("157",1,(255,255,255))
    minum2 = miFuente.render("300",1,(255,255,255))
    minum3 = miFuente.render("150",1,(255,255,255))
    minum4 = miFuente.render("22",1,(255,255,255))
    minum5 = miFuente.render("987",1,(255,255,255))
    # numero bola 1
    ventana.blit(minum1,(ventana.get_width()-610,ventana.get_height()-575))
    ventana.blit(minum1,(ventana.get_width()-610,ventana.get_height()-545))
    # numero bola 2
    ventana.blit(minum2,(ventana.get_width()-410,ventana.get_height()-575))
    ventana.blit(minum2,(ventana.get_width()-410,ventana.get_height()-545))
      # numero bola 3
    ventana.blit(minum3,(ventana.get_width()-210,ventana.get_height()-575))
    ventana.blit(minum3,(ventana.get_width()-210,ventana.get_height()-545))
    # numero bola 4
    ventana.blit(minum4,(ventana.get_width()-480,ventana.get_height()-315))
    ventana.blit(minum4,(ventana.get_width()-480,ventana.get_height()-290))
     # numero bola 5
    ventana.blit(minum5,(ventana.get_width()-290,ventana.get_height()-315))
    ventana.blit(minum5,(ventana.get_width()-290,ventana.get_height()-290))